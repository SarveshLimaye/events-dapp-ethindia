...
const LoginPage = () => {
    ...
    return (React.createElement("div", { className: classes.bgCover },
        React.createElement("main", { className: classes.container },
            React.createElement("h1", null, "Biconomy SDK React Web3Auth Example"),
            React.createElement(Button, { onClickFunc: !address
                    ? connect
                    : () => {
            ...
            selectedAccount && address && (React.createElement("div", null,
                React.createElement("h2", null, "Smart Account Address"),
                React.createElement("p", null, selectedAccount.smartAccountAddress))),
            address && (React.createElement(Button, { onClickFunc: () => getUserInfo(), title: "Get User Info" })),
            userInfo && (React.createElement("div", { style: { maxWidth: 800, wordBreak: "break-all" } },
                React.createElement("h2", null, "User Info"),
                React.createElement("pre", { style: { whiteSpace: "pre-wrap" } }, JSON.stringify(userInfo, null, 2)))))));
};
